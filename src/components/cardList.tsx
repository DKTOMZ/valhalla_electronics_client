        ...
        <div className="relative justify-start bg-transparent rounded-md overflow-x-auto overflow-y-hidden">
            <div ref={cardListRef} className={`flex flex-row items-center pt-2 gap-x-3 overflow-x-auto card-list px-3 overflow-y-hidden`}>
                {items.map((item,index)=>{
                    return <div key={index} style={{height:'300px', width: '240px'}} className="max-sm:!h-80 max-sm:!w-60 dark:bg-slate-800 bg-zinc-100 duration-500 dark:shadow-gray-400 shadow-md shadow-zinc-800 md:dark:hover:shadow-orange-400 max-md:dark:active:shadow-orange-400 md:dark:hover:shadow-md max-md:dark:active:shadow-md md:hover:shadow-md max-md:active:shadow-md md:hover:shadow-orange-600 max-md:active:shadow-orange-600 card z-0 mb-1 flex-shrink-0 rounded-md" >
